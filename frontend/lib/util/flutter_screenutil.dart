...
class ScreenUtil {
  ...
  void init(BuildContext context) {
    ...
    if (_textScaleFactor! > 1.36) _textScaleFactorLimit = 1.36;
  }
  ...
  setSp(num fontSize, bool isHorizontal) => allowFontScaling
      ? (isHorizontal ? setHeight(fontSize) : setWidth(fontSize)) / (_textScaleFactor! / _textScaleFactorLimit)
